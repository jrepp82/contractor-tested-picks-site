...
(function connectPrestigeStoreNetwork(){
  const destinations=[
    ...
    {label:'Local Services',title:'Prestige Remodeling',description:'Remodeling, exterior work, carpentry, welding and fabrication serving Manitowoc and the surrounding lakeshore.',url:'contact.html#lead-form',cta:'Request an Estimate →',rel:'noopener'}
  ];
...
(function routeStalePrestigeDomainLinks(){
  document.querySelectorAll('a[href^="https://PrestigeRemodelingWI.com"],a[href^="https://prestigeremodelingwi.com"]').forEach(link=>{
    link.href='contact.html#lead-form';
